...
boolean_atom:
    TKBIDENTIFIER { $$ = new NBoolAtom($1); printf("create boolean_atom1: %s %s\n", $$, $1); }
...
analog_expression:
    analog_atom { $$ = $1; ((NAnalog*)$1)->setOperator("non_t"); printf("create analog_expression1: %s %s\n", $$, $1); }
    ...
    | TKABS '(' analog_expression ')' { $$ = $3; ((NAnalog*)$3)->setOperator("abs_t"); printf("create analog_expression4: abs\n"); }
...
analog_atom:
    TKAIDENTIFIER { $$ = new NAnalog($1); printf("create analog_atom1: %s\n", $1); }
    ;
