...
define_directive:
    ...
    | TKDEFINE TKBIDENTIFIER TKEQUAL stl_property ';' { printf("create define_directive2: %s\n", $2); }

property_declaration_list:
    property_declaration { /*root = $5;*/ printf("create property_declaration_list1\n"); }
    | property_declaration_list property_declaration { printf("create property_declaration_list2\n"); }
    ;

property_declaration:
    TKIDENTIFIER TKASSERT ':' property ';' { printf("create property_declaration1\n"); }

property:
    stl_property { ast.setAST($1); printf("create property1\n"); }
...
stl_property:
    ...
    | TKG_WEAK stl_property { $$ = new NAlways($2, NULL); printf("create stl_property11 always\n"); }
    | TKG_WEAK range stl_property { $$ = new NAlways($3, NULL); printf("create stl_property12 always - with range\n"); } %prec TKG_STRONG_T
    ...
    | TKF_WEAK range stl_property { $$ = new NEventually($3, NULL); printf("create stl_property19 eventually - with range\n"); } %prec TKF_WEAK_T
...
boolean_atom:
    TKBIDENTIFIER { $$ = new NPredicate(NULL, NULL, $1); printf("create boolean_atom1: %s %s\n", $$, $1); }
    | boolean_expression { printf("create boolean_atom2: %s %s\n", $$, $1); }
    ;

boolean_expression:
    analog_expression TKLEQ TKREAL { printf("create boolean_expression1 TKLEQ: %s %f\n", $1, $3); }
    | analog_expression TKLESS TKREAL { printf("create boolean_expression2 TKLESS: %f\n", $3); }
    ...
    | analog_expression TKEQ TKREAL { printf("create boolean_expression5 TKEQ: %f\n", $3); }
...
analog_expression:
    ...
    | TKABS '(' analog_expression ')' { printf("create analog_expression4\n"); }
...
analog_atom:
    TKAIDENTIFIER { printf("create analog_atom1: %s\n", $1); }
    ;

range:
    '[' TKREAL ':' TKREAL ']' { printf("create range1: %f:%f\n", $2, $4); }
