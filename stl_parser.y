...
boolean_expression:
    ...
    | analog_expression TKLESS TKREAL { $$ = new NPredicate((BooleanExpression*)$1, NULL, "smaller_t", $3); /*((NPredicate*)$$)->setVariable("bla");*/ printf("create boolean_expression2 TKLESS: %f\n", $3); }
    ...
    | analog_expression TKEQ TKREAL { $$ = new NPredicate((BooleanExpression*)$1, NULL, "equal_t", $3); /*((NPredicate*)$$)->setVariable("bla");*/ printf("create boolean_expression5 TKEQ: %f\n", $3); }
...
analog_expression:
    analog_atom { $$ = $1; ((NAnalog*)$$)->setOperator("non_t"); printf("create analog_expression1: %s %s\n", $$, $1); }
    ...
    | TKABS '(' analog_expression ')' { $$ = $3; ((NAnalog*)$$)->setOperator("abs_t"); printf("create analog_expression4: abs\n"); }
...
analog_atom:
    TKAIDENTIFIER { $$ = new NAnalog(NULL, NULL, $1); printf("create analog_atom1: %s\n", $1); }
    ;
